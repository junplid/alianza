  ...
  return (
    <article className='hover:shadow-main-3 hover:-translate-y-1 duration-300 cursor-pointer hover:bg-main group flex flex-col justify-between rounded-xl bg-grey-light p-7'>
      <div>
        ...
        <h2 className='group-hover:text-w text-normal mb-1 text-2xl font-semibold'>
          {props.title}
        </h2>
        <p className='group-hover:text-w font-light text-lg text-normal-2 leading-relaxed'>
          {props.pharagraph}
        </p>
      </div>
      <div className='mt-4 flex justify-end'>
        <Link
          href={props.link ?? "/"}
          className='group-hover:bg-main-2 bg-main h-14 w-20 rounded-md grid place-items-center hover:bg-main-hover hover:-translate-y-0.5 duration-200 hover:shadow-main-2'
        >
          <BsArrowRightCircle
